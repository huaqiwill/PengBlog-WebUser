    ...
    <div class="main-grid">
      ...
      <div>
        <template v-if="article.articleContent">
          <a-card class="post-html">
            <!-- 文章标题 -->
            <h1 v-if="article.articleTitle" class="text-xl">
            ...
            <!-- 文章内容 -->
            <div class="markdown-body" ref="articleRef" v-html="article.articleContent"></div>
          </a-card>
        </template>

        <div v-else class="bg-ob-deep-800 px-14 py-16 rounded shadow block min-h-screen">
