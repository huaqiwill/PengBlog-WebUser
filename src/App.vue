<template>
  <div :class="[appWrapperClass, theme]" :style="wrapperStyle">
    <div
      class="app-container max-w-10/12 lg:max-w-screen-2xl px-4 lg:px-32"
...
//
let wrapperStyle = ref({ 'min-height': '100vh' })
...
const initialApp = () => {
  ...
  wrapperHeight -= (footerHeight ?? 0) * 2
  wrapperStyle.value = {
